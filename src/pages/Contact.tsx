  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 lg:py-24 max-w-3xl">
        <h1 className="font-serif text-3xl lg:text-4xl font-bold text-center mb-12">
          Contact Us
        </h1>
        ...
        <div className="bg-secondary/50 rounded-xl p-6 text-center space-y-1 mb-12">
          <p className="text-foreground font-medium text-sm">
            Phone Support · Monday to Saturday
          </p>
          <p className="text-muted-foreground text-sm">9:30 AM – 7:30 PM (IST)</p>
        </div>
